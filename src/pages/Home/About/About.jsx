...
const About = () => {
    return (
        <>
            <section className=" bg-stone-100 pb-7 ">
                <h1 className="mt-2 text-3xl font-extrabold leading-8 tracking-tight text-gray-900  sm:text-4xl text-center py-10">Get to Know Us: Our Story & Mission</h1>
                        ...
                        <div className="flex flex-wrap ">
                                ...
                                <div className="relative lg:max-w-md">
                                    ...
                                    <div
                                        ...
                                        <p className="text-lg font-semibold md:w-72">
                                            ...
                                            Successfully Providing business solutions from 2 years
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                                ...
                                <p className="mb-6 text-base leading-7 text-gray-500 dark:text-gray-400">
                                    Welcome to <span className="text-[#FF0000]">Fitness First</span>! We are dedicated to empowering individuals on their journey to optimal health and fitness. Our platform strives to provide comprehensive resources, expert guidance, and inspiration for beginners and fitness enthusiasts alike. Whether you're seeking workout routines, nutritional advice, or wellness tips, we aim to be your trusted companion in achieving your fitness goals. Join our vibrant community and embark on a transformative path towards a healthier lifestyle with us.
                                </p>
                                <a href="#"
