...
const Footer = () => {
    return (
        <>
            <footer className="bg-stone-100 dark:bg-gray-900">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center ">© 2023 <a href="/" className="hover:underline">Fitness First</a>. All Rights Reserved.
                        </span>
