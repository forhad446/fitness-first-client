        ...
        <div className="my-10">
            <div className="relative max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
                <div className="max-w-lg mx-auto overflow-hidden rounded-lg shadow-lg pricing-box lg:max-w-none lg:flex">
                    <div className="px-6 py-8 bg-stone-100 lg:flex-shrink-1 lg:p-12">
                            ...
                            <ul className="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 lg:row-gap-5">
                                <li className="flex items-start lg:col-span-1">
                                    ...
                                    <p className="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">
                                        Daily Movement and Active Breaks
                                    </p>
                                </li>
                                <li className="flex items-start lg:col-span-1">
                                    <div className="flex-shrink-0">
                                ...
                                <li className="flex items-start lg:col-span-1">
                                    ...
                                    <p className="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">
                                        Mindfulness and Relaxation Techniques (10-15 minutes)
                                    </p>
                                </li>
                            </ul>
                        </div>
